...
function cardLines(card, selected, idx) {
  ...
  // differ — a session in `list-pages` on branch `docs-pass` —
...
//   profile: `cf-personal-billing-svc` gives Z = `personal-billing-svc`, which is not a
//   directory anybody has. So a hand-run `fleet-grid.mjs cf-personal-billing-svc --plain`
...
// from a real one — `feat/policy-policy-beside-fo…` is a plausible branch name. These are
