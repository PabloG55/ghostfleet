...
| **[docs/attachments.md](docs/attachments.md)** | **Research, nothing built.** Can you send a photo from the phone to an agent? What was measured, the cheapest honest design, and why two of three agents cannot receive one |
