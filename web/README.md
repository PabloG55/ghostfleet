...
│ policy-beside · feat/policy-polic… │   worktree · branch  (+ agent when it isn't claude)
...
`policy-beside` and counted one session too few, and the session was the pre-#48 screen — a
