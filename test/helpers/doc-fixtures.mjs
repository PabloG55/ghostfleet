...
// when it is kebab-cased (`policy-beside`) and left alone otherwise: a one-word check would
...
// what a token is, so nothing is filtered by shape and `acme-api` is caught as readily
// as `policy-beside`.
